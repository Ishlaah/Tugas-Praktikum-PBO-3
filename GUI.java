...
//        add(lblCSA);
        ...
        lblLength.setBounds(100,5,200,20);
    ...
    public void actionPerformed(ActionEvent e) {
        ErorHandling er = new ErorHandling();
        ...
        if(e.getSource() == BCount){
            ...
            if(t > 0 && p > 0 && l > 0){  
                ...
                SA.setText("Square Area   =  " + String.valueOf(balok.Luas()));
                SC.setText("Square Circumstance   =  " + String.valueOf(balok.Keliling()));
                CV.setText("Cuboid Volume =  " + String.valueOf(balok.Volume()));
                CSA.setText("Cuboid Surface Area  =  " + String.valueOf(balok.Luas(p,l,t)));       
                }
        }
